...
import 'package:hac/layers/presentation/notifiers/company/filter_rating_company.dart';
import 'package:hac/layers/presentation/notifiers/company/rating_company_notifier.dart';
...
class RatingCompany extends StatelessWidget {
  const RatingCompany({super.key});

  @override
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(create: (context) => RatingCompanyNotifier(),child: const SubRatingCompany(),);
  }
}


class SubRatingCompany extends StatelessWidget {
  const SubRatingCompany({super.key});
...
class FilterField extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final notifier = context.watch<RatingCompanyNotifier>();
    return Center(
      child: SizedBox(
        width: 335.w,
        height: 42.h,
            ...
            onTap: () => showModalBottomSheet<dynamic>(
              ...
              builder: (BuildContext context) {
                return ChangeNotifierProvider(
                  create: (context) => FilterRatingCompany(),
                  child: const Banner()
                );
              },
            ),
...
class AcceptButton extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final notifier = context.watch<FilterRatingCompany>();
    return Center(
      child: SizedBox(
        width: 183.w,
        height: 46.h,
