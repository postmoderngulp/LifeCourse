...
import 'package:hac/layers/presentation/notifiers/company/filter_main_company_notifier.dart';
import 'package:hac/layers/presentation/notifiers/company/main_screen_notifier_company.dart';
...
class MainScreenCompany extends StatelessWidget {
  const MainScreenCompany({super.key});

  @override
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(create: (context) => MainScreenNotifierCompany(),child: const SubMainScreenCompany(),);
  }
}



class SubMainScreenCompany extends StatelessWidget {
  const SubMainScreenCompany({super.key});
...
class SearchField extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final notifier = context.watch<MainScreenNotifierCompany>();
    return Center(
      child: SizedBox(
        width: 335.w,
        height: 42.h,
            ...
            onTap: () => showModalBottomSheet<dynamic>(
              ...
              builder: (BuildContext context) {
                return ChangeNotifierProvider(
                  create: (context) => FilterMainCompanyNotifier(),
                  child: Container(
...
class CityField extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final notifier = context.watch<FilterMainCompanyNotifier>();
